...
let charactersNames = [];
console.log("Array: ", charactersNames);
...
console.log("Array risultante: ", charactersNames);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "female") {
    femaleCharacters[counter] = starWarsCharacters[i];
    counter++;
  }
}
...
console.log("Il nuovo array modificato: ", starWarsCharacters);
...
console.log("NUOVA LUNGHEZZA CHARACTERSNAMES: ", charactersNames.length);
console.log("Nuovo array ottenuto: ", charactersNames);
/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che selezioni un elemento casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/

const randomNumber = Math.floor(Math.random() * 9);
console.log("Numero random ottenuto: ", randomNumber);
console.log("Oggetto dell'array preso: ", starWarsCharacters[randomNumber]);
console.log(
  "Il mio nome è ",
  ...
  "kg. Il colore dei miei capelli è ",
  starWarsCharacters[randomNumber].hair_color,
  " e la mia skin color è ",
